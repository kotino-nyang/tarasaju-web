...
export default function PrivacyPage() {
  return (
    <>
      <Header />
      <main className="min-h-screen bg-gradient-to-br from-background to-sub-background pt-32 pb-20">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl">
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-8">개인정보처리방침</h1>

          <div className="bg-white/80 rounded-xl border border-japandi-border shadow-sm p-6 md:p-8 space-y-8">
            <section>
            ...
            <section>
              <h2 className="text-xl font-bold text-foreground mb-4">제1조 (개인정보의 처리 목적)</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-foreground mb-4">제4조 (개인정보처리의 위탁)</h2>
              <p className="text-foreground/80">
            ...
            <section>
              <h2 className="text-xl font-bold text-foreground mb-4">제5조 (정보주체의 권리·의무 및 행사방법)</h2>
              <div className="space-y-2 text-foreground/80">
            ...
            <section>
              <h2 className="text-xl font-bold text-foreground mb-4">제8조 (개인정보 보호책임자)</h2>
              <div className="space-y-2 text-foreground/80">
                <p>회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.</p>
                <div className="mt-3 bg-sub-background/30 p-4 rounded-lg">
                  <p className="font-medium">▶ 개인정보 보호책임자</p>
                  <p className="ml-4">성명 : 고수빈</p>
                  <p className="ml-4">직책 : 대표</p>
                  <p className="ml-4">연락처 : 010-4648-0046, tarasajukr@gmail.com</p>
                </div>
              </div>
            </section>

            <section>
              <h2 className="text-xl font-bold text-foreground mb-4">제9조 (개인정보 처리방침 변경)</h2>
              <p className="text-foreground/80">
          ...
          <div className="mt-8 text-center">
            <Link
              href="/"
              className="inline-block rounded-lg bg-terracotta px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-terracotta/90 shadow-sm"
            >
              메인으로 돌아가기
            </Link>
          </div>
