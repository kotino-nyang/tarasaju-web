    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-4xl bg-woody-brown rounded-3xl border border-background/10 shadow-[0_8px_32px_rgba(44,22,1,0.3)] max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-8 md:p-12">
          <h1 className="text-3xl md:text-5xl font-bold text-background mb-10">이용약관</h1>

          <div className="space-y-12 text-background/70 leading-relaxed font-light">
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제1조 (목적)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제2조 (정의)</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제3조 (약관 등의 명시와 설명 및 개정)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제4조 (서비스의 제공 및 변경)</h2>
              <div className="space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제5조 (서비스의 중단)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제6조 (회원가입)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제7조 (회원 탈퇴 및 자격 상실 등)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제8조 (회원에 대한 통지)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제9조 (구매신청 및 개인정보 제공 동의 등)</h2>
              <div className="space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제10조 (계약의 성립)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제11조 (지급방법)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제12조 (수신확인통지·구매신청 변경 및 취소)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제13조 (재화 등의 공급)</h2>
              <div className="space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제14조 (환급)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제15조 (청약철회 등)</h2>
              <div className="space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제16조 (청약철회 등의 효과)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제17조 (개인정보보호)</h2>
              <div className="space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제18조 ("몰"의 의무)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제19조 (이용자의 의무)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제20조 (저작권의 귀속 및 이용제한)</h2>
              <div className="space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제21조 (AI 서비스의 면책 및 한계)</h2>
              <div className="space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-background mb-4">제22조 (재판권 및 준거법)</h2>
              <p>
                ① "몰"과 이용자 간에 발생한 전자상거래 분쟁에 관한 소송은 제소 당시의 이용자의 주소에 의하고, 대한민국법을 적용합니다.
              </p>
            </section>

            <section className="mt-16 pt-10 border-t border-background/10">
