      ...
      <div className="relative w-full max-w-4xl bg-white rounded-2xl border border-gray-200 shadow-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제3조 (약관 등의 명시와 설명 및 개정)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제7조 (회원 탈퇴 및 자격 상실 등)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제8조 (회원에 대한 통지)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제9조 (구매신청 및 개인정보 제공 동의 등)</h2>
              <div className="space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제10조 (계약의 성립)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제11조 (지급방법)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제12조 (수신확인통지·구매신청 변경 및 취소)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제13조 (재화 등의 공급)</h2>
              <div className="space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제14조 (환급)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제15조 (청약철회 등)</h2>
              <div className="space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제16조 (청약철회 등의 효과)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제17조 (개인정보보호)</h2>
              <div className="space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제18조 ("몰"의 의무)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제19조 (이용자의 의무)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제20조 (저작권의 귀속 및 이용제한)</h2>
              <div className="space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제21조 (AI 서비스의 면책 및 한계)</h2>
              <div className="space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">제22조 (재판권 및 준거법)</h2>
              <p>
